...
const ManifestFile: Partial<ManifestOptions> = {
  ...
  description:
    "Waanverse is more than a platform; it's a community-driven space where every voice matters. Whether you're an explorer, creator, or someone looking to connect with like-minded individuals, Waanverse welcomes you to a social experience that transcends boundaries.",
  display: "standalone",
  icons: [
    {
  ...
  shortcuts: [
    {
      ...
      icons: [
        {
          src: "https://files.waanverse.com/icons/compose.png",
          sizes: "96x96",
          type: "image/png",
          purpose: "maskable",
        },
