...
const LikeButton = ({
    ...
    return (
        <span className="flex  like_frame items-center">
            <button
                className={`like_main  flex items-center justify-center p-1 rounded-full`}
                onClick={onclick}
            >
                {type === "like" ? (
                    <span className="animate-pong">
                        <svg
                            className="w-5 h-5 animate-pong text-red-500"
                            viewBox="0 0 24 24"
                            fill="none"
            ...
            <span className="text-xs text-gray-500  like_text">{likes}</span>
        </span>
    );
};
