...
const VerifiedMsg = () => {
  return (
    ...
    <div className="p-6 bg-primary-100/70 gap-x-6 flex-wrap border-primary-400 dark:bg-primary-900/30 border dark:border-primary-700 flex items-center justify-center flex-col rounded-md">
      <div className="mb-4">
      <svg aria-label="Verified Account" role="img" className="w-10 mx-auto h-10 inline-block" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
