...
const Frame = () => {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 border-r-2 border-gray-100 dark:border-gray-800 left-0 z-50 sm:z-0 w-5/6 sm:w-72 lg:w-[25%]   h-screen transition-transform -translate-x-full ${
