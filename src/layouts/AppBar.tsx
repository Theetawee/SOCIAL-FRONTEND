...
const AppBar = () => {
    ...
    return (
        <header
            ...
            className="fixed z-20 h-16 flex backdrop-filter firefox:bg-opacity-90 backdrop-blur-lg bg-opacity-30 items-center justify-center top-0 left-0 w-full  border-b dark:border-gray-800 border-gray-200 sm:ml-72 lg:mr-[32%]   lg:ml-[25%]"
        >
