                ...
                <div className="flex justify-between items-center">
                    ...
                    <div>
                        <div className="flex items-center">
                            <button className="bg-gray-50 relative dark:bg-gray-800 p-2 flex items-center justify-center rounded-full">
                                {notifications>0 && <span className="absolute top-0 right-0 bg-rose-500 text-white w-5 h-5 p-1 rounded-full flex items-center justify-center text-xs">{notifications}</span>}
