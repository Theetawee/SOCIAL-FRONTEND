...
const AppBar = () => {
    ...
    return (
        <header
            ...
            className="fixed z-20 h-16 flex items-center justify-center top-0 left-0 w-full bg-white dark:bg-gray-900 border-b dark:border-gray-800 border-gray-200"
        >
